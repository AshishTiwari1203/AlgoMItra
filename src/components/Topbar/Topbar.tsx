  ...
  return (
    <nav className="relative flex h-[50px] w-full shrink-0 items-center px-5 bg-dark-layer-1 text-dark-gray-7">
      <div
        ...
        <Link href="/" className="flex items-center justify-center h-20 mr-5">
        ...
        <div className="flex items-center space-x-4 flex-shrink-0">
          <div>
            <a
              href="https://docs.google.com/forms/d/e/1FAIpQLSdujjm7JYUWiX63TtaE2V_ydDL26TLr9B59PotmL1IwlID1yw/viewform?usp=header"
              target="_blank"
              rel="noreferrer"
